...
def quantize(
	...
	Args:
		...
		colorspace (str, optional): The color space to use for conversion. Can be any of the
		    colorspaces supported by Pillow. Defaults to 'LAB'.
	...
	# We need to convert it to a fake RGB picture, or else funny things happen when using LAB and
	# calling the tobytes() method down below.
